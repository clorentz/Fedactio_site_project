 ...
 */
final class Version20180824095815 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
      ...
      //  $this->addSql('ALTER TABLE competition CHANGE inscription_start_date inscription_start_date DATE NOT NULL, CHANGE inscription_end_date inscription_end_date DATE NOT NULL');
        $this->addSql('ALTER TABLE training_answer ADD image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE training_answer DROP image');
    }
}
