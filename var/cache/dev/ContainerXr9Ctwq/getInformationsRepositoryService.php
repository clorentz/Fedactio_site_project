...
// Returns the private 'App\Repository\InformationsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InformationsRepository.php';

return $this->privates['App\Repository\InformationsRepository'] = new \App\Repository\InformationsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
