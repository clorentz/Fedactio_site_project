...
class __TwigTemplate_1cef18d3c372a6e172defa1a9c9d460a3aa7162be468a030a2f51e00447d07c0 extends Twig_Template
{
    private $source;
...
";
    ...
    {
        return new Twig_Source("{# templates/bundles/TwigBundle/Exception/error.html.twig #}
...
{% block body %}
    ...
    <p>
        Il y a eu une erreur lors du chargement de la page. Veuillez verifier l'URL entrée ou <a href=\"{{ path('homepage') }}\">retourner à la page d'acccueil</a>.
        Si le problème persiste, veuillez envoyer un mail à l'administrateur: <a href=\"mailto:info@fedactio.be?Subject=Erreur%20Pangea\" target=\"_top\">Envoyer un mail</a>
    </p>
{% endblock %}
", "@Twig/Exception/error.html.twig", "/home/clorentz/www/fedactio_pangea/templates/bundles/TwigBundle/Exception/error.html.twig");
    }
}
