...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CompetitionRepository' => function () {
    return ($this->privates['App\Repository\CompetitionRepository'] ?? $this->load('getCompetitionRepositoryService.php'));
}, 'App\\Repository\\GalleryImageRepository' => function () {
    return ($this->privates['App\Repository\GalleryImageRepository'] ?? $this->load('getGalleryImageRepositoryService.php'));
}, 'App\\Repository\\InformationsItemRepository' => function () {
    return ($this->privates['App\Repository\InformationsItemRepository'] ?? $this->load('getInformationsItemRepositoryService.php'));
}, 'App\\Repository\\InformationsRepository' => function () {
    return ($this->privates['App\Repository\InformationsRepository'] ?? $this->load('getInformationsRepositoryService.php'));
}, 'App\\Repository\\PreviousQuizRepository' => function () {
    return ($this->privates['App\Repository\PreviousQuizRepository'] ?? $this->load('getPreviousQuizRepositoryService.php'));
}, 'App\\Repository\\RegulationItemRepository' => function () {
    return ($this->privates['App\Repository\RegulationItemRepository'] ?? $this->load('getRegulationItemRepositoryService.php'));
}, 'App\\Repository\\RegulationRepository' => function () {
    return ($this->privates['App\Repository\RegulationRepository'] ?? $this->load('getRegulationRepositoryService.php'));
}, 'App\\Repository\\TrainingAnswerRepository' => function () {
    return ($this->privates['App\Repository\TrainingAnswerRepository'] ?? $this->load('getTrainingAnswerRepositoryService.php'));
}, 'App\\Repository\\TrainingClientAnswerRepository' => function () {
    return ($this->privates['App\Repository\TrainingClientAnswerRepository'] ?? $this->load('getTrainingClientAnswerRepositoryService.php'));
}, 'App\\Repository\\TrainingQuestionRepository' => function () {
    return ($this->privates['App\Repository\TrainingQuestionRepository'] ?? $this->load('getTrainingQuestionRepositoryService.php'));
}, 'App\\Repository\\TrainingQuizRepository' => function () {
    return ($this->privates['App\Repository\TrainingQuizRepository'] ?? $this->load('getTrainingQuizRepositoryService.php'));
