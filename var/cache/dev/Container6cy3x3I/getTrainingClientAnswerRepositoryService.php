...
// Returns the private 'App\Repository\TrainingClientAnswerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrainingClientAnswerRepository.php';

return $this->privates['App\Repository\TrainingClientAnswerRepository'] = new \App\Repository\TrainingClientAnswerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
