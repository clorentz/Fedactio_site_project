...
// Returns the private 'App\Repository\PreviousQuizRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PreviousQuizRepository.php';

return $this->privates['App\Repository\PreviousQuizRepository'] = new \App\Repository\PreviousQuizRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
