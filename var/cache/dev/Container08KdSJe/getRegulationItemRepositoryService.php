...
// Returns the private 'App\Repository\RegulationItemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RegulationItemRepository.php';

return $this->privates['App\Repository\RegulationItemRepository'] = new \App\Repository\RegulationItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
