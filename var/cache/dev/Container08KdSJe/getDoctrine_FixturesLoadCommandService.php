...
include_once $this->targetDirs[3].'/src/DataFixtures/CompetitionFixtures.php';
...
include_once $this->targetDirs[3].'/src/DataFixtures/InformationsFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/InformationsItemFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/RegulationFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/RegulationItemFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/TrainingAnswerFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/TrainingQuestionFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/TrainingQuizFixtures.php';
...
$a->addFixtures(array(0 => new \App\DataFixtures\CompetitionFixtures(), 1 => new \App\DataFixtures\InformationsFixtures(), 2 => new \App\DataFixtures\InformationsItemFixtures(), 3 => new \App\DataFixtures\RegulationFixtures(), 4 => new \App\DataFixtures\RegulationItemFixtures(), 5 => new \App\DataFixtures\TrainingAnswerFixtures(), 6 => new \App\DataFixtures\TrainingQuestionFixtures(), 7 => new \App\DataFixtures\TrainingQuizFixtures(), 8 => new \App\DataFixtures\UserFixtures()));
