...
// Returns the private 'App\Repository\TrainingQuestionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrainingQuestionRepository.php';

return $this->privates['App\Repository\TrainingQuestionRepository'] = new \App\Repository\TrainingQuestionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
