...
// Returns the private 'App\Repository\GalleryImageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GalleryImageRepository.php';

return $this->privates['App\Repository\GalleryImageRepository'] = new \App\Repository\GalleryImageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
