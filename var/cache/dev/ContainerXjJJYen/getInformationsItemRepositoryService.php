...
// Returns the private 'App\Repository\InformationsItemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InformationsItemRepository.php';

return $this->privates['App\Repository\InformationsItemRepository'] = new \App\Repository\InformationsItemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
