...
// Returns the private 'App\Repository\TrainingQuizRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrainingQuizRepository.php';

return $this->privates['App\Repository\TrainingQuizRepository'] = new \App\Repository\TrainingQuizRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
