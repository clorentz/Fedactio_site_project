...
return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('admin' => array('password' => '$2y$12$273VFaVW7rLcA2jyPF.TAubihKDjxaGX2S081T2PWN5s9WXKE.SKe', 'roles' => array(0 => 'ROLE_ADMIN'))));
