...
// Returns the private 'App\Repository\TrainingAnswerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrainingAnswerRepository.php';

return $this->privates['App\Repository\TrainingAnswerRepository'] = new \App\Repository\TrainingAnswerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
