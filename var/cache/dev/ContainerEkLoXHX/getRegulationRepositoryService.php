...
// Returns the private 'App\Repository\RegulationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RegulationRepository.php';

return $this->privates['App\Repository\RegulationRepository'] = new \App\Repository\RegulationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
